...
(async () => {
  ...
  await fs.writeFile("angina-medication-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("angina-medication-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
